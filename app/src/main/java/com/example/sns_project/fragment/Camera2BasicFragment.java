...
public class Camera2BasicFragment extends Fragment
     ...
     * The {@link android.util.Size} of camera preview.
     */
    private int facingId = 0; //초반 카메라 위치 변수
    ...
    /**
     * An {@link ImageReader} that handles still imaㅌge capture.
     */
...
//    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.change: {
                if(facingId == CameraCharacteristics.LENS_FACING_FRONT){ //카메라가 전면부일 경우
